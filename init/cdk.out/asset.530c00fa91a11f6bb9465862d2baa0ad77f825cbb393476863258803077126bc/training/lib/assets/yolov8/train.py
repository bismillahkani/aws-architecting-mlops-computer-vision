...
if __name__ == '__main__':
    ...
    # copy the inference code with the model file
    shutil.copytree("./code", opt.model_output_dir+"/code", dirs_exist_ok=True)
    shutil.copy(f'runs/detect/train/weights/best.{"onnx" if opt.export_to_onnx else "pt"}', opt.model_output_dir+"/code")

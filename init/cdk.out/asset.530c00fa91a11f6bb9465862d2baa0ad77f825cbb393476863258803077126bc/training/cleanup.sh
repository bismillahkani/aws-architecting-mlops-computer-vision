...
aws cloudformation delete-stack --stack-name MLOps-Training-SageMaker-Pipeline-Stack
aws cloudformation wait stack-delete-complete --stack-name MLOps-Training-SageMaker-Pipeline-Stack
